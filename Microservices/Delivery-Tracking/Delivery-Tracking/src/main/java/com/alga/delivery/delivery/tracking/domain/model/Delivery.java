...
import com.alga.delivery.delivery.tracking.domain.event.DeliveryFulfilledEvent;
import com.alga.delivery.delivery.tracking.domain.event.DeliveryPickUpEvent;
import com.alga.delivery.delivery.tracking.domain.event.DeliveryPlacedEvent;
...
public class Delivery extends AbstractAggregateRoot<Delivery> {
    ...
    public UUID addItem(String name, int quantity) {
        Item item = Item.brandNey(name, quantity, this);
        items.add(item);
        calculateTotalItems();
        return item.getId();
    }
    ...
    private void calculateTotalItems() {
        int totalItem = getItems().stream().mapToInt(Item::getQuantity).sum();
