package com.alga.delivery.courier.management.api.controller;

import com.alga.delivery.courier.management.api.model.CourierInput;
import com.alga.delivery.courier.management.api.model.CourierPayoutCalculationInput;
import com.alga.delivery.courier.management.api.model.CourierPayoutResultModel;
import com.alga.delivery.courier.management.domain.model.Courier;
import com.alga.delivery.courier.management.domain.repository.CourierRepository;
import com.alga.delivery.courier.management.domain.service.CourierPayoutService;
import com.alga.delivery.courier.management.domain.service.CourierRegistrationService;
