package com.alga.delivery.courier.management.infrastructure.kafka;

import com.alga.delivery.courier.management.domain.service.CourierDeliveryService;
import com.alga.delivery.courier.management.infrastructure.event.DeliveryFulfilledIntegrationEvent;
import com.alga.delivery.courier.management.infrastructure.event.DeliveryPlacedIntegrationEvent;
...
public class KakfaDeliveriesMessageHandler {
